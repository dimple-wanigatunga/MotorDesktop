...
public class CguTest {
	
	public static String browserType = GlobalConstants.INTERNET_EXPLORER;

	public static void main(String[] args) {
			
		//System.setProperty("webdriver.ie.driver",System.getProperty("user.dir")+"//src//IEDriverServer.exe");
		System.out.println("Main");
		WebDriver iedriver = SeleniumWrapper.getInstance(browserType);
		...
		//iedriver.findElement(By.xpath("//table[2]/tbody/tr[2]/td[3]/a[1]")).click();
	...
	/*
		...
		iedriver.findElementByXPath("//*[@id='policy_start_date_visual']").sendKeys("");
